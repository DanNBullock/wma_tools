function [classificationOut] =bsc_segmentAntPostTracts_v3(wbfg, atlasPath,varargin)
%
...
% -atlasPath: path to aparc.a2009s+aseg.nii.gz
...
[classificationOut] =bsc_segmentCingulum_v3(wbfg,atlasPath,categoryPrior);
