function [fsStats] =bsc_computeFresurferStats(fsDir)
% [fsStats] =bsc_computeFresurferStats(fsDir)
%
% This function computes a number of stats 
% Inputs:
...
%set it in a table
fsStats=cell2table(tableData,'VariableNames',columnNames);
